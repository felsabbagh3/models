...
command="./run_export_inference_graph.sh mytrain/"$network"/pipeline.config mytrain/"$network"/train/model.ckpt mytrain/"$network"/frozen_graph/ False mytrain/"$network"/train/gradients.gz"
eval $command
